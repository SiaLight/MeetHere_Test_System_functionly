...
public class OrdersTest {
  ...
  public void orders() {
    ...
    driver.findElement(By.cssSelector(".el-menu-demo > .el-menu-item:nth-child(1)")).click();
    driver.findElement(By.cssSelector(".el-menu-demo > .el-menu-item:nth-child(2)")).click();
    {
      WebElement element = driver.findElement(By.cssSelector(".el-table__body-wrapper"));
      Actions builder = new Actions(driver);
    ...
    assertThat(driver.switchTo().alert().getText(), is("取消成功"));
    driver.close();
  }
}
